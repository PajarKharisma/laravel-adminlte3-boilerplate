/*
 ...
 Source Schema         : monitoring_tp_ugm

 Target Server Type    : MySQL
 Target Server Version : 50724
 File Encoding         : 65001

 Date: 09/12/2021 14:40:33
*/
...
INSERT INTO `migrations` VALUES (5, '2021_12_04_085438_laravel_entrust_setup_tables', 1);
...
CREATE TABLE `permissions`  (
  ...
  UNIQUE INDEX `permissions_id_unique`(`id`) USING BTREE,
...
-- ----------------------------
INSERT INTO `role_user` VALUES ('454988c7-9b9f-472f-b5d0-099b0c6db395', 'admin');
...
CREATE TABLE `roles`  (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  UNIQUE INDEX `roles_id_unique`(`id`) USING BTREE,
...
-- Records of roles
-- ----------------------------
INSERT INTO `roles` VALUES ('454988c7-9b9f-472f-b5d0-099b0c6db395', 'admin', 'ADMIN', 'Memiliki Hak Akses Penuh', '2021-12-06 04:49:08', '2021-12-06 09:01:13');
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('admin', 'admin', NULL, 'admin@admin.com', NULL, '$2y$10$khQjwQb0.ZSqA3mJczgR/eVaQEFihte70I2wLx8w.sMSHNN.tFv.K', '6SoYX7r22tMyhJgqAG0pmxQ2Yhp9O1w7T4hHUFanR48NKGRCE0ZnSUtTKe37', '2021-12-04 09:26:03', '2021-12-08 15:50:55');
